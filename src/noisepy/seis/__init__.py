...
- download:         download continuous noise data based on obspy's core functions of
...
- stack_cross_correlations:
                    Used to assemble and/or stack all cross-correlation functions computed for the station
