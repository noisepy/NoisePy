...
# WIP: 3 ways of getting station information (Inventory):
# - From the StationXml stream in the ASDF file
# - From a stations.txt CSV file (generated by S0)
# - From individual inventory files inside a respdir with obspy.read_inventory. Where does this usually reside?
