    ...
    if net1 and sta1 and comp1:
        ...
        if isource in slist:
            ...
            for ireceiver in rlist:
                ...
                plt.plot(
                    tt,
                    data[indx0 - tindx : indx0 + tindx + 1] + dist,
                    color,
                    linewidth=0.8,
                )
                ...
                if tag in slist:
                    ...
                    if os.path.isfile(tfile1):
                        ...
                        try:
                            ...
                            plt.plot(
                                tt,
                                data1[indx0 - tindx : indx0 + tindx + 1] + dist,
                                "r",
                                linewidth=0.8,
                            )
                        except Exception:
                    ...
                    if os.path.isfile(tfile2):
                        ...
                        try:
                            ...
                            plt.plot(
                                tt,
                                data2[indx0 - tindx : indx0 + tindx + 1] + dist,
                                "g--",
                                linewidth=0.8,
                            )
                        except Exception:
    ...
    if net2 and sta2 and comp2:
        ...
        for ii in range(len(afiles)):
            ...
            with pyasdf.ASDFDataSet(afiles[ii], mode="r") as ds:
                ...
                plt.plot(
                    tt,
                    data[indx0 - tindx : indx0 + tindx + 1] + ii * 2,
                    "k-",
                    linewidth=0.5,
                )
        ...
        if stackdir:
            ...
            with pyasdf.ASDFDataSet(stackfile, mode="r") as stack_ds:
                ...
                plt.plot(
                    tt,
                    data[indx0 - tindx : indx0 + tindx + 1] + ii * 2 + 2,
                    "b-",
                    linewidth=1,
                )
        ...
        for recever in rlist:
            ...
            if stackdir:
                ...
                with pyasdf.ASDFDataSet(stackfile, mode="r") as stack_ds:
                    ...
                    plt.plot(
                        tt,
                        data[indx0 - tindx : indx0 + tindx + 1] - 2,
                        "b-",
                        linewidth=1,
                    )
            # ---------highlight zero time------------
...
def plot_ZH_pmotion(sfile, freqmin, freqmax, net1, sta1, net2=None, sta2=None):
    ...
    if net2 and sta2:
        ...
        if isource in slist:
            ...
            plt.subplot(243)
            plt.plot(
                data1[indx0 : indx0 + tindx + 1],
                data[indx0 : indx0 + tindx + 1],
                "k-",
                linewidth=0.5,
            )
            plt.xlabel("ZR")
