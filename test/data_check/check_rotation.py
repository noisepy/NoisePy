...
big_rot = np.asarray([[-cos(az_test)*cos(baz_test),cos(az_test)*sin(baz_test),-sin(az_test)*sin(baz_test),sin(az_test)*cos(baz_test)],
            ...
            [-sin(az_test)*cos(baz_test),sin(az_test)*sin(baz_test),cos(az_test)*sin(baz_test),-cos(az_test)*cos(baz_test)]])
az_rot = np.asarray( [[cos(az_test),-sin(az_test)],
            [sin(az_test),cos(az_test)]])
baz_rot =np.asarray( [[-cos(baz_test),-sin(baz_test)],
            [sin(baz_test),-cos(baz_test)]])
#
